/**
 * Zoho workspace apps (CRM, Books, One) used to reuse the first instance's
 * profile for every catalog add. Each app now gets its own profile like Gmail.
 */

const WORKSPACE_APP_IDS = ['zoho-crm', 'zoho-books', 'zoho-one'];
